...
import com.example.managementapp.Adapter.WeeklyMerchantAdapter;
import com.example.managementapp.Model.WeeklyMerchant.Result;
...
public class WeeklyMerchantRegisterActivity extends AppCompatActivity {
    ...
    private void getWeeklyData() {
        ...
        Call<WeeklyMerchant> weekendDataCall = api.getByWeekendList();
